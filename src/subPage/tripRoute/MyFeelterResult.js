        ...
        <div className="container" id="myftresult">
            ...
            <ul className="result d-flex justify-content-center align-items-center">
                <li className="img-wrap">
                    <img src="https://d-hye.github.io/source/img/main_img/md_slide3.jpg" alt="대표이미지" className="profile-img" />
                ...
                <ul className="review-list">
                    <li className="d-flex justify-content-center align-items-center">
                        <div className="review-info">
                            <img src="https://d-hye.github.io/source/img/main_img/md_slide3.jpg" alt="대표이미지" className="review-img"/>
